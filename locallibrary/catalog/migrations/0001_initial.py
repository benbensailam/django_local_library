...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='genre',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('name'), name='genre_name_case_insensitive', violation_error_message='Genre with this name already exists (case-insensitive match).'),
        ),
        migrations.AddField(
